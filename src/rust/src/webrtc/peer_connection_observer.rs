...
#[allow(non_snake_case)]
extern "C" fn pc_observer_OnIceCandidatesRemoved<T>(_cc_ptr: *mut CallConnection<T>)
where
    T: CallPlatform,
{
    ...
    T: CallPlatform,
{
    ...
    if let Ok(cc) = object {
        ...
        match new_state {
            ...
            IceConnectionFailed => {
                cc.inject_ice_connection_failed().unwrap_or_else(|e| {
                    error!("Problems adding ice_connection_failed to fsm: {}", e)
                });
            }
            IceConnectionDisconnected => {
                cc.inject_ice_connection_disconnected().unwrap_or_else(|e| {
...
#[allow(non_snake_case)]
extern "C" fn pc_observer_OnConnectionChange<T>(_cc_ptr: *mut CallConnection<T>)
where
    T: CallPlatform,
{
...
#[allow(non_snake_case)]
extern "C" fn pc_observer_OnIceConnectionReceivingChange<T>(_cc_ptr: *mut CallConnection<T>)
where
    T: CallPlatform,
{
...
#[allow(non_snake_case)]
extern "C" fn pc_observer_OnIceGatheringChange<T>(_cc_ptr: *mut CallConnection<T>)
where
    T: CallPlatform,
{
...
#[allow(non_snake_case)]
extern "C" fn pc_observer_OnRemoveStream<T>(_cc_ptr: *mut CallConnection<T>)
where
    T: CallPlatform,
{
...
#[allow(non_snake_case)]
extern "C" fn pc_observer_OnRenegotiationNeeded<T>(_cc_ptr: *mut CallConnection<T>)
where
    T: CallPlatform,
{
...
#[allow(non_snake_case)]
extern "C" fn pc_observer_OnAddTrack<T>(_cc_ptr: *mut CallConnection<T>)
where
    T: CallPlatform,
{
...
#[allow(non_snake_case)]
extern "C" fn pc_observer_OnTrack<T>(_cc_ptr: *mut CallConnection<T>)
where
    T: CallPlatform,
{
...
where
    T: CallPlatform,
{
    onIceCandidate: extern "C" fn(*mut CallConnection<T>, *const CppIceCandidate),
    onIceCandidatesRemoved: extern "C" fn(*mut CallConnection<T>),
    onSignalingChange: extern "C" fn(*mut CallConnection<T>, SignalingState),
    onIceConnectionChange: extern "C" fn(*mut CallConnection<T>, IceConnectionState),
    onConnectionChange: extern "C" fn(*mut CallConnection<T>),
    onIceConnectionReceivingChange: extern "C" fn(*mut CallConnection<T>),
    onIceGatheringChange: extern "C" fn(*mut CallConnection<T>),
    onAddStream: extern "C" fn(*mut CallConnection<T>, *const RffiMediaStreamInterface),
    onRemoveStream: extern "C" fn(*mut CallConnection<T>),
    onDataChannel: extern "C" fn(*mut CallConnection<T>, *const RffiDataChannelInterface),
    onRenegotiationNeeded: extern "C" fn(*mut CallConnection<T>),
    onAddTrack: extern "C" fn(*mut CallConnection<T>),
    onTrack: extern "C" fn(*mut CallConnection<T>),
}
