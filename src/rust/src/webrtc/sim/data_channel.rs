...
pub unsafe fn Rust_dataChannelSend(_dc_interface: *const RffiDataChannelInterface,
                                   _buffer: *const u8, _len: size_t, _binary: bool) -> bool {
    info!("Rust_dataChannelSend(): ");
    true
}

#[allow(non_snake_case)]
pub unsafe fn Rust_registerDataChannelObserver(_dc_interface: *const RffiDataChannelInterface,
                                               _dc_observer:  *const RffiDataChannelObserverInterface) {
    info!("Rust_registerDataChannelObserver(): ");
}

#[allow(non_snake_case)]
pub unsafe fn Rust_unregisterDataChannelObserver(_dc_interface: *const RffiDataChannelInterface,
                                                 _dc_observer:  *const RffiDataChannelObserverInterface) {
    info!("Rust_unregisterDataChannelObserver(): ");
}

#[allow(non_snake_case)]
pub unsafe fn Rust_dataChannelGetLabel(_dc_interface: *const RffiDataChannelInterface) -> *const c_char {
