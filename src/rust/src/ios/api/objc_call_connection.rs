...
pub extern "C" fn ringRtcClose(callConnection: *mut c_void) -> *mut c_void {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn ringRtcDispose(callConnection: *mut c_void) -> *mut c_void {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn ringRtcCreateCallConnectionObserver(
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn ringRtcSendOffer(
    callConnection: *mut c_void,
    appCallConnection: *mut c_void,
) -> *mut c_void {
    match ios_platform::native_send_offer(
        callConnection as *mut IOSCallConnection,
...
pub extern "C" fn ringRtcReceivedAnswer(
    ...
    let answer_bytes = unsafe { slice::from_raw_parts(bytes, len as usize) };

    match str::from_utf8(answer_bytes) {
        Ok(session_desc) => {
            match ios_platform::native_handle_answer(
                callConnection as *mut IOSCallConnection,
                session_desc,
            ) {
                Ok(_v) => {
...
pub extern "C" fn ringRtcReceivedOffer(
    ...
    // Build the Rust string.
    let offer_bytes = unsafe { slice::from_raw_parts(bytes, len as usize) };

    match str::from_utf8(offer_bytes) {
        Ok(session_desc) => {
            match ios_platform::native_handle_offer(
                callConnection as *mut IOSCallConnection,
                appCallConnection as *mut AppCallConnection,
                session_desc,
            ) {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn ringRtcHangup(callConnection: *mut c_void) -> *mut c_void {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn ringRtcAccept(callConnection: *mut c_void) -> *mut c_void {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn ringRtcSendVideoStatus(
    callConnection: *mut c_void,
    enabled: bool,
) -> *mut c_void {
    match ios_platform::native_send_video_status(callConnection as *mut IOSCallConnection, enabled)
    {
        Ok(_v) => {
            // Return the object reference back as indication of success.
            callConnection
...
pub extern "C" fn ringRtcReceivedIceCandidate(
    ...
    let sdp_bytes = unsafe { slice::from_raw_parts(sdpBytes, sdpLen as usize) };
    ...
    let sdp_mid_bytes = unsafe { slice::from_raw_parts(sdpMidBytes, sdpMidLen as usize) };
    ...
    match ios_platform::native_add_ice_candidate(
        callConnection as *mut IOSCallConnection,
        sdp_mid_string,
        lineIndex,
        sdp_string,
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn ringRtcSendBusy(callConnection: *mut c_void, _callId: u64) -> *mut c_void {
