...
pub extern "C" fn ringRtcCreateCallConnectionFactory(
    appCallConnectionFactory: *mut c_void,
) -> *mut c_void {
    match call_connection_factory::native_create_call_connection_factory(
        appCallConnectionFactory as *mut AppPeerConnectionFactory,
    ) {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn ringRtcFreeFactory(factory: *mut c_void) -> *mut c_void {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn ringRtcCreateCallConnection(
    callConnectionFactory: *mut c_void,
    ...
    match call_connection_factory::native_create_call_connection(
        callConnectionFactory as *mut IOSCallConnectionFactory,
