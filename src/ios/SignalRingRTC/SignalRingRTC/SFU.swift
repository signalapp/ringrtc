...
public class SFUClient {
    ...
    /// - Parameter epoch: optional epoch generated by the server at link creation time
    @MainActor
    public func peek(sfuUrl: String, authCredentialPresentation: [UInt8], linkRootKey: CallLinkRootKey, epoch: CallLinkEpoch? = nil) async -> PeekResponse {
        return await withCheckedContinuation { continuation in
            ...
            authCredentialPresentation.withRtcBytes { authCredentialPresentation in
                linkRootKey.bytes.withRtcBytes { linkRootKey in
                    rtc_sfu_peekCallLink(self.httpClient.rtcClient, requestId, sfuUrl, authCredentialPresentation, linkRootKey, CallLinkEpoch.toOptionalU32(epoch), delegateWrapper.asRtc())
                }
            }
        }
    }
    ...
    @MainActor
    public func readCallLink(sfuUrl: String, authCredentialPresentation: [UInt8], linkRootKey: CallLinkRootKey, epoch: CallLinkEpoch? = nil) async -> SFUResult<CallLinkState> {
        return await withCheckedContinuation { continuation in
            ...
            authCredentialPresentation.withRtcBytes { authCredentialPresentation in
                linkRootKey.bytes.withRtcBytes { linkRootKey in
                    rtc_sfu_readCallLink(self.httpClient.rtcClient, requestId, sfuUrl, authCredentialPresentation, linkRootKey, CallLinkEpoch.toOptionalU32(epoch), delegateWrapper.asRtc())
                }
            }
        }
    }
    ...
    @MainActor
    public func updateCallLinkName(sfuUrl: String, authCredentialPresentation: [UInt8], linkRootKey: CallLinkRootKey, epoch: CallLinkEpoch? = nil, adminPasskey: Data, newName: String) async -> SFUResult<CallLinkState> {
        return await withCheckedContinuation { continuation in
            ...
            authCredentialPresentation.withRtcBytes { createCredentialPresentation in
                linkRootKey.bytes.withRtcBytes { linkRootKey in
                    adminPasskey.withRtcBytes { adminPasskey in
                        rtc_sfu_updateCallLink(self.httpClient.rtcClient, requestId, sfuUrl, createCredentialPresentation, linkRootKey, CallLinkEpoch.toOptionalU32(epoch), adminPasskey, newName, -1, -1, delegateWrapper.asRtc())
                    }
                }
            }
        }
    ...
    @MainActor
    public func updateCallLinkRestrictions(sfuUrl: String, authCredentialPresentation: [UInt8], linkRootKey: CallLinkRootKey, epoch: CallLinkEpoch? = nil, adminPasskey: Data, restrictions: CallLinkState.Restrictions) async -> SFUResult<CallLinkState> {
        return await withCheckedContinuation { continuation in
            ...
            authCredentialPresentation.withRtcBytes { createCredentialPresentation in
                linkRootKey.bytes.withRtcBytes { linkRootKey in
                    adminPasskey.withRtcBytes { adminPasskey in
                        ...
                        rtc_sfu_updateCallLink(self.httpClient.rtcClient, requestId, sfuUrl, createCredentialPresentation, linkRootKey, CallLinkEpoch.toOptionalU32(epoch), adminPasskey, nil, rawRestrictions, -1, delegateWrapper.asRtc())
                    }
                }
            }
        }
    ...
    /// - Parameter authCredentialPresentation: a serialized CallLinkAuthCredentialPresentation
    /// - Parameter linkRootKey: the root key for the call link
    /// - Parameter epochId: optional epoch ID generated by the server at link creation time
    /// - Parameter adminPasskey: the passkey specified when the link was created
    @MainActor
    public func deleteCallLink(sfuUrl: String, authCredentialPresentation: [UInt8], linkRootKey: CallLinkRootKey, epoch: CallLinkEpoch? = nil, adminPasskey: Data) async -> SFUResult<()> {
        return await withCheckedContinuation { continuation in
            ...
            authCredentialPresentation.withRtcBytes { createCredentialPresentation in
                linkRootKey.bytes.withRtcBytes { linkRootKey in
                    adminPasskey.withRtcBytes { adminPasskey in
                        rtc_sfu_deleteCallLink(self.httpClient.rtcClient, requestId, sfuUrl, createCredentialPresentation, linkRootKey, CallLinkEpoch.toOptionalU32(epoch), adminPasskey, delegateWrapper.asEmptyRtc())
                    }
                }
            }
        }
